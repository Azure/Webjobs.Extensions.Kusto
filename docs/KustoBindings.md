# Kusto bindings for Azure Functions - Overview

## Table of Contents
- [Kusto bindings for Azure Functions - Overview](#azure-sql-bindings-for-azure-functions---overview)
...
Kusto Input bindings take a SQL query or stored procedure to run and returns the output to the function.
